      ...
      >
        <div className="container">
          <div className={
            ...
            <Logo /> <span style={{ color: '#F9FAFF', fontSize: 24 }}>Orders.finance</span>
            {!hideNav &&
              <React.Fragment>
                <button
                  ref={this.hamburger}
                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <a href="https://t.me/OrdersFinance" onClick={this.closeMenu}>Telegram</a>
                      </li>
                      <li>
                        <a href="https://twitter.com/ordersfinance" onClick={this.closeMenu}>Twitter</a>
                      </li>
                      <li>
                        <a href="https://github.com/ordersfinance" onClick={this.closeMenu}>Github</a>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
